#ifdef __APPLE__
  #define LUNEXA_LOCAL_SYMBOL(x) .private_extern x
#else
  #define LUNEXA_LOCAL_SYMBOL(x) .hidden x
#endif
...
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
LUNEXA_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
